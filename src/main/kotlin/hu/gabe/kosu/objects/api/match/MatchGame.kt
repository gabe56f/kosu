...
object MatchScoringTypeSerializer : KSerializer<MatchScoringType> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("hu.gabe.objects.match.MatchScoringType", PrimitiveKind.STRING)
...
object MatchTeamTypeSerializer : KSerializer<MatchTeamType> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("hu.gabe.objects.match.MatchTeamType", PrimitiveKind.STRING)
