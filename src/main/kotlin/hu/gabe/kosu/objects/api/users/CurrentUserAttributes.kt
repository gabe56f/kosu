...
data class CurrentUserAttributes(
    ...
    fun asBeatmapsetPermissions(): BeatmapsetDiscussionPermissions = BeatmapsetDiscussionPermissions(canDestroy!!, canReopen!!, canModerateKudosu!!, canResolve!!, voteScore!!).also { it.kosu = kosu }

    fun asChatChannelPermissions(): ChatChannelUserAttributes = ChatChannelUserAttributes(canMessage!!, lastReadId!!, cantMessageReason).also { it.kosu = kosu }
}
