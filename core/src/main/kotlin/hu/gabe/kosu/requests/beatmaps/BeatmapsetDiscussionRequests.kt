...
import hu.gabe.kosu.objects.api.beatmapset.*
...
class BeatmapsetDiscussionRequests(kosu: Kosu) : BaseRequestV2(kosu) {
    ...
    ): BeatmapsetDiscussionPostsResult = client.get(
    ...
    fun getVotes(
        ...
        page: Int? = null,
        cursorString: String? = null
    ): BeatmapsetDiscussionVotesResult = client.get(
    ...
    fun searchDiscussions(
        ...
        user: Long? = null,
        cursorString: String? = null
    ): BeatmapsetDiscussionsResult = client.get(
